<div flex="v" h-center contain="info" nopadding style="width: 250px; padding: 1em 0; height: 100vh; background-color: #0f2755; flex-shrink: 0;" sharp-edges>
    <div fullwidth flex="v" h-center nogap>
        ...
        <span white-text>Agent Panel</span>
    </div>
    <div flex="v" nogap noshadowtoall fullwidth>
        <a href="../agent/dashboard" button contain="overdark" flex="h" h-center v-center style="border-radius: 0; width: 100%;" nogap>
        ...
        <a href="../agent/orders" button contain="overdark" flex="h" h-center v-center style="border-radius: 0; width: 100%;" nogap>
