...
<head>
    ...
    <title>Edit Info | ISA Admin</title>
</head>
...
<body back-light>
    ...
    <div style="display: none;" id="admin-id"><?php echo $_SESSION["id"]; ?></div>
    ...
    <script>
        let user_id = document.querySelector("#admin-id").innerText;
        ...
        function submitInfo() {
            let adminId = document.querySelector("#admin-id").innerText;
            let inputs = [];
