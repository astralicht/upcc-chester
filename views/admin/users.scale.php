...
<body>
    ...
    <script>
        ...
        var table_bodies = { "users": document.querySelector("#users-table tbody"), };
        ...
        function printUsersPages(data) {
            ...
            controls["previous"].onclick = ()=>{previousUsersTablePage()};
            controls["next"].onclick = ()=>{nextUsersTablePage(total_pages)};
        ...
        function deleteUsers() {
            const tickedBoxes = document.querySelectorAll("input[type=checkbox]:checked");
            fetch("../admin/removeusers").then(response => response.json()).then(data => {
